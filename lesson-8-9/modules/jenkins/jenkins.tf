# Default StorageClass backed by the EBS CSI driver (needed for Jenkins PVC)
...
# IAM role assumed by the Jenkins service account (IRSA) to push images to ECR via Kaniko
